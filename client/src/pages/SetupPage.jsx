...
export default function SetupPage() {
  ...
  async function handleBlogCreation(e) {
    ...
    setError("");
    if (!form.name.trim()) {
      setError("Please give your blog a name.");
      return;
    }
    setLoading(true);
    try {
      ...
      <main className="setup-page">
        <div className="setup-card">
          ...
          <p className="setup-sub">
            You can always change these later. Give readers a sense of what you
            write about.
          </p>
          {error && (
            ...
            <div className="setup-fields">
              <div className="field">
                <label htmlFor="setup-name">
                  Blog name <span style={{ color: "var(--accent)" }}>*</span>
                </label>
                <input
                  id="setup-name"
                  type="text"
                  placeholder="The Midnight Dispatch"
                  value={form.name}
                  onChange={set("name")}
                  autoFocus
                />
              ...
              <div className="field">
                ...
                <input
                  id="setup-tagline"
                  type="text"
                  placeholder="Dispatches from the edge of thought"
                  value={form.tagline}
              ...
              <div className="field">
                ...
                <textarea
                  id="setup-about"
                  rows={4}
                  placeholder="A short description of what you write about…"
                  value={form.about}
                  onChange={set("about")}
                />
              </div>
